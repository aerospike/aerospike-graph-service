...
public class B_LP_O_S_SE_SL_RowCodec extends RowCodec {
    private static final B_LP_O_S_SE_SL_RowCodec INSTANCE = new B_LP_O_S_SE_SL_RowCodec();

    public static B_LP_O_S_SE_SL_RowCodec getInstance() {
        return INSTANCE;
    }

    private B_LP_O_S_SE_SL_RowCodec() {
    }
