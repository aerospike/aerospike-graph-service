...
public class FireflySummaryCallTest extends AbstractFireflySuite {
    ...
    public void testSummary() throws InterruptedException {
        ...
        g.V().drop().iterate();
        Thread.sleep(5000);
        final List<Object> summaryCallEmpty = g.call("aerospike.graph.metadata.summary").toList();
        ...
        final List<Object> summaryCallGrateful = g.call("aerospike.graph.metadata.summary").toList();
    ...
    public void testPrettySummary() throws InterruptedException {
        ...
        g.V().drop().iterate();
        Thread.sleep(5000);
        final String summaryCall = (String) g.call("aerospike.graph.metadata.summary").with("pretty").next();
        ...
        final String actualOutputGrateful = (String) g.call("aerospike.graph.metadata.summary").with("pretty").next();
