...
//            final Iterator<Edge> edgeIteratorFromString = fireflyGraph.query.getPagedScan("from", setfrom, binfrom, P.eq("BitQuill"), fireflyGraph::edgeFromRecord);
...
//
//            final Iterator<Edge> edgeIteratorFromInteger = fireflyGraph.query.getPagedScan("years", setfrom, binfrom, P.eq(1), fireflyGraph::edgeFromRecord);
//            final Iterator<Edge> edgeIteratorFromLong = fireflyGraph.query.getPagedScan("years", setfrom, binfrom, P.eq(1L), fireflyGraph::edgeFromRecord);
//            Assert.assertFalse(edgeIteratorFromInteger.hasNext());
//            Assert.assertFalse(edgeIteratorFromLong.hasNext());
//
//            final Iterator<Edge> edgeIteratorYearString = fireflyGraph.query.getPagedScan("years", setfrom, binfrom, P.eq("29"), fireflyGraph::edgeFromRecord);
//            Assert.assertFalse(edgeIteratorYearString.hasNext());
//
//            final Iterator<Edge> edgeIteratorYearLong = fireflyGraph.query.getPagedScan("years", setfrom, binfrom, P.eq(3L), fireflyGraph::edgeFromRecord);
...
//
//            final Iterator<Edge> edgeIteratorYearInteger = fireflyGraph.query.getPagedScan("years", setfrom, binfrom, P.eq(3), fireflyGraph::edgeFromRecord);
...
//
//            final Iterator<Edge> edgeIteratorLocationString = fireflyGraph.query.getPagedScan("location", setfrom, binfrom, P.eq("Canada"), fireflyGraph::edgeFromRecord);
...
//            final Iterator<FireflyEdge> edges = fireflyGraph.query.getPagedScan(null, db.EDGE_AERO_SET, AerospikeConnection.LABEL, P.eq("owns"), graph::edgeFromRecord);
