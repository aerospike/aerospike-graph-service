...
public enum GraphError {
    ...
    static {
        ...
        ERROR_MESSAGES.put(SCAN_NOT_ALLOWED.code, "This query requires a scan, which is not enabled. Set '" + SCAN_QUERY_ENABLED + "' to 'true', use '.with(\"" + SCAN_QUERY_ENABLED + "\", true)' for this traversal, or create an appropriate index.");
