...
Testing Firefly
----------
The integration tests use the configuration at [firefly-gremlin/src/test/resources/integration-test-settings.properties](https://github.com/citrusleaf/firefly/blob/main/firefly-gremlin/src/test/resources/integration-test-settings.properties)(url). Update these setting to point to your Aerospike instance.
