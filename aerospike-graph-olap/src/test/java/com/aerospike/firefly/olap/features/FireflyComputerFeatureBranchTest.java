...
@CucumberOptions(
        ...
        objectFactory = FireflyComputerFeatureBranchTest.FireflyComputerGraphGuiceFactory.class,
        features = { "classpath:/org/apache/tinkerpop/gremlin/test/features/branch" },
        plugin = {"progress", "junit:target/cucumber.xml"})
public class FireflyComputerFeatureBranchTest {
