...
public class TestFireflyDropStrategyIntegration {
    ...
    public void beforeEach() {
        ...
        SETUP_GRAPH.getAerospikeOperations().writeEdge(SETUP_GRAPH.getIdFactory().createEdgeId(getEdgeId()), "coworker", Collections.emptyList(),
                lyndon, simon);
        SETUP_GRAPH.getAerospikeOperations().writeEdge(SETUP_GRAPH.getIdFactory().createEdgeId(getEdgeId()), "coworker", Collections.emptyList(),
                simon, lyndon);
        SETUP_GRAPH.getAerospikeOperations().writeEdge(SETUP_GRAPH.getIdFactory().createEdgeId(getEdgeId()), "owns", Collections.emptyList(),
                vincent, lyndon);
        SETUP_GRAPH.getAerospikeOperations().writeEdge(SETUP_GRAPH.getIdFactory().createEdgeId(getEdgeId()), "owns", Collections.emptyList(),
                mycroft, lyndon);
