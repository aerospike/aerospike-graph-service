...
public class TestAdjacencySindexFilters {
    ...
    public void testWithinPhatEdgePushdown() {
        ...
        try (final FireflyGraph phatFirefly = FireflyGraph.open(conf)) {
            ...
            Assert.assertEquals(2, supernodePMap.get(v1.id.getKeyHashString()).size());
            Assert.assertEquals(2, supernodePMap.get(v2.id.getKeyHashString()).size());
            Assert.assertEquals(2, supernodePMap.get(v3.id.getKeyHashString()).size());
            Assert.assertEquals(2, supernodePMap.get(v4.id.getKeyHashString()).size());
