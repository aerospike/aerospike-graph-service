...
public class LP_NL_O_OB_S_SE_SL_RowDecoder implements RowDecoder {
    private static final LP_NL_O_OB_S_SE_SL_RowDecoder INSTANCE = new LP_NL_O_OB_S_SE_SL_RowDecoder();

    public static LP_NL_O_OB_S_SE_SL_RowDecoder getInstance() {
        return INSTANCE;
    }

    private LP_NL_O_OB_S_SE_SL_RowDecoder() {
    }
