...
| aerospike.client.clientPolicy.timeout      | 2000           | 1 - 100000                                                          | Timeout assigned to the Aerospike client (in milliseconds).                                                        |
...
| aaerospike.client.writePolicy.maxRetries              | 0       | (Currently internal until writes are idempotent) Max number of times to retry a write to the Aerospike cluster.                                               |
