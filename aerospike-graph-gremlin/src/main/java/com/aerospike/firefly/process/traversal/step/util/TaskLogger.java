...
public class TaskLogger {
    ...
    private static final TaskLogger instance = new TaskLogger();
    ...
    public static void complete(final String message) {
        ...
        instance.durations.put(message, instance.durations.get(message) + Instant.now().toEpochMilli() - instance.lastLogTime);
        instance.lastLogTime = Instant.now().toEpochMilli();
    }
