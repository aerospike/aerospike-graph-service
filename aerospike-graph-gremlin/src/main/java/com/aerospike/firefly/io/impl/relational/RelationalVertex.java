...
public abstract class RelationalVertex extends FireflyVertex {
    ...
    protected RelationalVertex(final FireflyId fid,
        ...
        super(fid, label, graph, inEdgeIds, outEdgeIds, inEdgeCount, outEdgeCount, vertexPropertyIds, vertexPropertyValues, vertexPropertyValuesTypeHints, vertexPropertyIdToProperties, vertexPropertyIdToTypeHints, isEdgeCacheOverflowed, db);
    }
