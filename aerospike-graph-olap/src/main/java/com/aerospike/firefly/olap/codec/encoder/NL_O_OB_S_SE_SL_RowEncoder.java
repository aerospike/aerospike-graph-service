...
public class NL_O_OB_S_SE_SL_RowEncoder implements RowEncoder {
    private static final NL_O_OB_S_SE_SL_RowEncoder INSTANCE = new NL_O_OB_S_SE_SL_RowEncoder();

    public static NL_O_OB_S_SE_SL_RowEncoder getInstance() {
        return INSTANCE;
    }

    private NL_O_OB_S_SE_SL_RowEncoder() {
    }
