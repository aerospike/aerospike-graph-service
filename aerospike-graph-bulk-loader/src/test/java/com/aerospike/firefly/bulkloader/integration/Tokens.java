...
public final class Tokens {
    ...
    private static final Map<String, Path> INTEGRATION_TEST_CONFIGURATIONS = ImmutableMap.of(
            RelationalGraph.DATA_MODEL, Path.of("../conf/integration-test-settings-packed.properties"),
            RelationalGraph.DATA_MODEL + "-sindex", Path.of("../conf/integration-test-settings-packed-sindex.properties")
    );
