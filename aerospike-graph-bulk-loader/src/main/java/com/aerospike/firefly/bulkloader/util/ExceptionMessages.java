...
public class ExceptionMessages {
    ...
    public static final String BAD_EDGE_COUNT_HOT_KEY = "The bulk loader has encountered the maximum allowed number of errors during the current operation. Please use \"g.call(\"aerospike.graphloader.bulk-load.errors\")\" for specifics on the encountered issues, adjust your data or configuration as necessary, and attempt the operation again.";
