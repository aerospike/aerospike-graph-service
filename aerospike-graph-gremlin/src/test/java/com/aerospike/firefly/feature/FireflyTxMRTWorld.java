...
public class FireflyTxMRTWorld extends FireflyWorldBase {
    ...
    static {
        empty = FireflyGraph.open(getConfiguration("empty", true, true));
        modern = createFireflyGraph("modern", TinkerFactory.createModern(), true, true);
        crew = createFireflyGraph("crew", TinkerFactory.createTheCrew(), true, true);
        sink = createFireflyGraph("sink", TinkerFactory.createKitchenSink(), true, true);
        grateful = createFireflyGraph("grateful", TinkerFactory.createGratefulDead(), true, true);
    }
