...
public class TestSparkBulkLoaderPacked extends TestSparkBulkLoaderBase {
    ...
    static private final String USE_PROVIDED_ID_FALSE_CONFIG = "src/test/resources/conf/packed/useProvidedIdFalse.properties";
    static private final String KEEP_ID_AS_PROPERTY_CONFIG = "src/test/resources/conf/packed/keepProvidedIdAsProperty.properties";
