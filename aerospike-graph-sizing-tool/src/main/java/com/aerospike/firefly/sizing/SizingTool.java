...
public class SizingTool {
    ...
    private final static Long EDGE_RECORD_VALUE_SIZE = 28L;
    ...
    private static Long vertexPropertyToSize(final PropertySchema propertySchema) {
        ...
        size += 8; // 1 map entry of empty map for properties of vertex property.
        size += 4; // Empty map.
        size += 8; // 1 map entry of empty map
        size += 4; // Empty map.
        return size;
    }
    ...
    private long getEdgeCacheEntrySize() {
