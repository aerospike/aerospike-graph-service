...
public class B_LP_O_P_S_SE_SL_RowDecoder implements RowDecoder {
    private static final B_LP_O_P_S_SE_SL_RowDecoder INSTANCE = new B_LP_O_P_S_SE_SL_RowDecoder();

    public static B_LP_O_P_S_SE_SL_RowDecoder getInstance() {
        return INSTANCE;
    }

    private B_LP_O_P_S_SE_SL_RowDecoder() {
    }
