...
public class FireflySummaryCallTest extends AbstractFireflySuite {
    ...
    public void testSummary() throws InterruptedException {
        ...
        g.V().drop().iterate();
        Thread.sleep(5000);
        final List<Object> summaryCallEmpty = g.call("aerospike.graph.admin.metadata.summary").toList();
        ...
        final List<Object> summaryCallGrateful = g.call("aerospike.graph.admin.metadata.summary").toList();
