...
@CucumberOptions(
        ...
        objectFactory = FireflyComputerFeatureMapTest.FireflyComputerGraphGuiceFactory.class,
        features = { "classpath:/org/apache/tinkerpop/gremlin/test/features/map" },
        plugin = {"progress", "junit:target/cucumber.xml"})
public class FireflyComputerFeatureMapTest {
