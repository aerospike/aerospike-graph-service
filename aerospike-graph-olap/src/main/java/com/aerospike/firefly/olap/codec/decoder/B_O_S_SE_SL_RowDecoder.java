...
public class B_O_S_SE_SL_RowDecoder implements RowDecoder {
    private static final B_O_S_SE_SL_RowDecoder INSTANCE = new B_O_S_SE_SL_RowDecoder();

    public static B_O_S_SE_SL_RowDecoder getInstance() {
        return INSTANCE;
    }

    private B_O_S_SE_SL_RowDecoder() {
    }
