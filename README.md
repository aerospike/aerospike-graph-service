...
firefly-gremlin/target/firefly-gremlin-0.3.0-SNAPSHOT-jar-with-dependencies.jar  
firefly-gremlin/target/firefly-gremlin-0.3.0-SNAPSHOT.jar
```
...
...  
gremlin> :install com.aerospike firefly-gremlin 0.3.0-SNAPSHOT  
==>Loaded: [com.aerospike, firefly-gremlin, 0.3.0-SNAPSHOT] - restart the console to use [aerospike.firefly]  
(exit)  
$ ~/software/apache-tinkerpop-gremlin-console-3.6.0/bin/gremlin.sh  
...  
