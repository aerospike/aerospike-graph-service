...
public class LP_NL_O_OB_S_SE_SL_RowEncoder implements RowEncoder{
    private static final LP_NL_O_OB_S_SE_SL_RowEncoder INSTANCE = new LP_NL_O_OB_S_SE_SL_RowEncoder();

    public static LP_NL_O_OB_S_SE_SL_RowEncoder getInstance() {
        return INSTANCE;
    }

    private LP_NL_O_OB_S_SE_SL_RowEncoder() {
    }
