...
public final class ConfigurationHelper {
    ...
    public static class Keys {
        ...
        public static final String PAGINATION_WORKERS = "aerospike.graph.pagination.index.workers";
    ...
    private static final Map<Object, String> defaultValues = new HashMap<>() {{
        ...
        put(Keys.PAGINATION_PAGE_QUEUE_SIZE, "100");
        put(Keys.PAGINATION_PAGE_SIZE, "40000");
