...
public class BulkLoaderServiceErrorsDeprecated<I, R> extends BulkLoaderServiceErrors<I, R> {
    public BulkLoaderServiceErrorsDeprecated(final FireflyGraph graph) {
        super(graph);
    }
