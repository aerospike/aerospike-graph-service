...
public class LP_O_OB_P_S_SE_SL_RowDecoder implements RowDecoder {
    private static final LP_O_OB_P_S_SE_SL_RowDecoder INSTANCE = new LP_O_OB_P_S_SE_SL_RowDecoder();

    public static LP_O_OB_P_S_SE_SL_RowDecoder getInstance() {
        return INSTANCE;
    }

    private LP_O_OB_P_S_SE_SL_RowDecoder() {
    }
