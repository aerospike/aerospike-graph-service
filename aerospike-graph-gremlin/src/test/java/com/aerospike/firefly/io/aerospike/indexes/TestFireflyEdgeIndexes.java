...
//            final Iterator<Edge> edgeIteratorNameString = GraphQuery.create(graph).getPagedSindex(fromIndex.get(), P.eq("BitQuill"), fireflyGraph::edgeFromRecord);
...
//
//            final Iterator<Edge> edgeIteratorNameInteger = GraphQuery.create(graph).getPagedSindex(fromIndex.get(), P.eq(1), fireflyGraph::edgeFromRecord);
//            final Iterator<Edge> edgeIteratorNameLong = GraphQuery.create(graph).getPagedSindex(fromIndex.get(), P.eq(1L), fireflyGraph::edgeFromRecord);
//            Assert.assertFalse(edgeIteratorNameInteger.hasNext());
//            Assert.assertFalse(edgeIteratorNameLong.hasNext());
//
//            final Iterator<Edge> edgeIteratorAgeString = GraphQuery.create(graph).getPagedSindex(yearsIndex.get(), P.eq("29"), fireflyGraph::edgeFromRecord);
//            Assert.assertFalse(edgeIteratorAgeString.hasNext());
//
//            // Looks like a mistake here.
//            final Iterator<Edge> edgeIteratorAgeLong = GraphQuery.create(graph).getPagedSindex(yearsIndex.get(), P.eq(3L), fireflyGraph::edgeFromRecord);
//            Assert.assertTrue(edgeIteratorAgeLong.hasNext());
//            Assert.assertEquals(Integer.valueOf(3), edgeIteratorAgeLong.next().value("years"));
//
//            final Iterator<Edge> edgeIteratorAgeInteger = GraphQuery.create(graph).getPagedSindex(yearsIndex.get(), P.eq(3), fireflyGraph::edgeFromRecord);
...
//
//            final Iterator<Edge> edgeIteratorFromInteger = fireflyGraphQuery.create(graph).getPagedScan("years", setfrom, binfrom, P.eq(1), fireflyGraph::edgeFromRecord);
//            final Iterator<Edge> edgeIteratorFromLong = fireflyGraphQuery.create(graph).getPagedScan("years", setfrom, binfrom, P.eq(1L), fireflyGraph::edgeFromRecord);
//            Assert.assertFalse(edgeIteratorFromInteger.hasNext());
//            Assert.assertFalse(edgeIteratorFromLong.hasNext());
//
//            final Iterator<Edge> edgeIteratorYearString = fireflyGraphQuery.create(graph).getPagedScan("years", setfrom, binfrom, P.eq("29"), fireflyGraph::edgeFromRecord);
//            Assert.assertFalse(edgeIteratorYearString.hasNext());
//
//            final Iterator<Edge> edgeIteratorYearLong = fireflyGraphQuery.create(graph).getPagedScan("years", setfrom, binfrom, P.eq(3L), fireflyGraph::edgeFromRecord);
...
//
//            final Iterator<Edge> edgeIteratorYearInteger = fireflyGraphQuery.create(graph).getPagedScan("years", setfrom, binfrom, P.eq(3), fireflyGraph::edgeFromRecord);
...
//
//            final Iterator<Edge> edgeIteratorLocationString = fireflyGraphQuery.create(graph).getPagedScan("location", setfrom, binfrom, P.eq("Canada"), fireflyGraph::edgeFromRecord);
