...
public class LP_O_OB_P_S_SE_SL_RowEncoder implements RowEncoder{
    private static final LP_O_OB_P_S_SE_SL_RowEncoder INSTANCE = new LP_O_OB_P_S_SE_SL_RowEncoder();

    public static LP_O_OB_P_S_SE_SL_RowEncoder getInstance() {
        return INSTANCE;
    }

    private LP_O_OB_P_S_SE_SL_RowEncoder() {
    }
