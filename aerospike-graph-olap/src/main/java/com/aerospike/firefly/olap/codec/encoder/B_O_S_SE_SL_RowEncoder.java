...
public class B_O_S_SE_SL_RowEncoder implements RowEncoder{
    private static final B_O_S_SE_SL_RowEncoder INSTANCE = new B_O_S_SE_SL_RowEncoder();

    public static B_O_S_SE_SL_RowEncoder getInstance() {
        return INSTANCE;
    }

    private B_O_S_SE_SL_RowEncoder() {
    }
