...
public class FireflyId {
    ...
    public static FireflyId fromUser(FireflyGraph graph, Class<? extends FireflyElement> type, Object id) {
    ...
    public static FireflyId fromAerospike(AerospikeConnection db, Class<? extends FireflyElement> type,FireflyRecord record) {
    ...
    public static FireflyId fromKeyValuesOrManager(FireflyGraph graph, Class<? extends FireflyElement> type, Object... keyValues) {
