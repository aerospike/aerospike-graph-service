...
public class IncrementingNumericIdManager extends BufferedNumericIdManager {
    protected IncrementingNumericIdManager(final String counterName, final long bufferSize) {
    ...
    protected Long getNextIdFromBuffers(final FireflyGraph graph, final long bufferSize, final AtomicLong idTracker,
        ...
        final long id = idTracker.getAndIncrement();
        if (id >= idTrigger.get()) {
