...
then mvn install:install-file \
        -Dfile=/opt/aerospike-graph/aerospike-graph-gremlin/target/aerospike-graph-gremlin-2.0.0.jar \
        ...
        -Dfile=/opt/aerospike-graph/aerospike-graph-gremlin/target/aerospike-graph-gremlin-2.0.0-SNAPSHOT.jar \
        -DgroupId=com.aerospike \
        -DartifactId=aerospike-graph-gremlin \
