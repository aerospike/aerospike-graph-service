...
public class O_OB_S_SE_SL_RowDecoder implements RowDecoder {
    private static final O_OB_S_SE_SL_RowDecoder INSTANCE = new O_OB_S_SE_SL_RowDecoder();

    public static O_OB_S_SE_SL_RowDecoder getInstance() {
        return INSTANCE;
    }

    private O_OB_S_SE_SL_RowDecoder() {
    }
