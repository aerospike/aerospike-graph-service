...
public class B_LP_O_S_SE_SL_RowEncoder implements RowEncoder {
    private static final B_LP_O_S_SE_SL_RowEncoder INSTANCE = new B_LP_O_S_SE_SL_RowEncoder();

    public static B_LP_O_S_SE_SL_RowEncoder getInstance() {
        return INSTANCE;
    }

    private B_LP_O_S_SE_SL_RowEncoder() {
    }
